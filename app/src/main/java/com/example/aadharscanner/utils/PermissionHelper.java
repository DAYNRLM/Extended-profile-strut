...
public class PermissionHelper {
    ...
    public void requestPermissionResult(int requestCode, @NonNull String permissions[], @NonNull int[] grantResults) {
        ...
        AppUtils.getInstance().showLog("Permission callback called-------", PermissionHelper.class);
        switch (requestCode) {
            case REQUEST_ID_MULTIPLE_PERMISSIONS: {
                ...
                if (grantResults.length > 0) {
                    ...
                    if (perms.get(Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED
                        ...
                        AppUtils.getInstance().showLog("sms & location services permission granted", PermissionHelper.class);
...
//                        finish();
                        ...
                        AppUtils.getInstance().showLog("Some permissions are not granted ask again", PermissionHelper.class);
