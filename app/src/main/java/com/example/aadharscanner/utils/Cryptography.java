...
public class Cryptography {
   ...
   /*used for outer layer encryption*/
    @NonNull
    String KEY_NEW= "$8791551593$7417592029$9634140210";
    @NonNull
    String IV_NEW = "$8791551593$7417592029$9634140210";
     ...
     */
    @NonNull
    public static final String md5(@NonNull final String inputString) {
     ...
     */
    private String encryptDecrypt(@NonNull String _inputText, @NonNull String _encryptionKey,
                                  @NonNull EncryptMode _mode, @NonNull String _initVector) throws UnsupportedEncodingException,
     ...
     * @throws UnsupportedEncodingException
     */
    public static String SHA256(@NonNull String text, int length) throws NoSuchAlgorithmException, UnsupportedEncodingException {
    ...
    public String encrypt(@NonNull String _plainText)
    ...
    public String decrypt(@NonNull String _encryptedText)
            throws InvalidKeyException, UnsupportedEncodingException,
            InvalidAlgorithmParameterException, IllegalBlockSizeException,
            BadPaddingException {
    ...
    public String decryptNewKey(@NonNull String _encryptedText)
            throws InvalidKeyException, UnsupportedEncodingException,
            InvalidAlgorithmParameterException, IllegalBlockSizeException,
            BadPaddingException {
        return encryptDecrypt(_encryptedText, KEY_NEW.replace("$",""), EncryptMode.DECRYPT, IV_NEW.replace("$",""));
    }

    public String encryptNewKey(@NonNull String _plainText)
            throws InvalidKeyException, UnsupportedEncodingException,
            InvalidAlgorithmParameterException, IllegalBlockSizeException,
            BadPaddingException {

        return encryptDecrypt(_plainText, KEY_NEW.replace("$",""), EncryptMode.ENCRYPT, IV_NEW.replace("$",""));
    }
