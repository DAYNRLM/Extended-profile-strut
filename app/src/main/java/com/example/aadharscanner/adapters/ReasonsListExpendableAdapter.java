...
public class ReasonsListExpendableAdapter extends BaseExpandableListAdapter {

    private Context context;
    List<MemberInactiveReasonData> expandableListTitle;
    HashMap<String, List<MemberLoanStatusData>> expandableListDetail;

    public ReasonsListExpendableAdapter(Context context, List<MemberInactiveReasonData> expandableListTitle,
                                        HashMap<String, List<MemberLoanStatusData>> expandableListDetail) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, @Nullable View convertView, ViewGroup parent) {
        MemberInactiveReasonData listTitle = (MemberInactiveReasonData) getGroup(groupPosition);
        if (convertView == null) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, @Nullable View convertView, ViewGroup parent) {
        final MemberLoanStatusData expandedListText = (MemberLoanStatusData) getChild(groupPosition, childPosition);
        if (convertView == null) {
            LayoutInflater layoutInflater = (LayoutInflater) this.context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
